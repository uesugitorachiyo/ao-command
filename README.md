...
recursive-improvement wording and broad_RSI remain denied." Command reads back
`highest_proven_live_class=public_safe_bounded_recursive_improvement_wording_generality_evidence`
...
live class is `public_safe_bounded_recursive_improvement_wording_generality_evidence` and the
